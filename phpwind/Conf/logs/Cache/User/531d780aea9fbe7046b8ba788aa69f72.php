...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="" name="picurl" id="img" style="width:500px" >  <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','icon')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a>
  <br/>
...
<TR>
  ...
  <TD><input type="input" class="px" id="url" value="" name="url" style="width:500px" >   <a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><br />
...
<TR>
  ...
  <TD><input type="input" class="px" id="keyword" value="0" name="orderss" style="width:500px" ><br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
