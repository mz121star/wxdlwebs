...
<div class="msgWrap">
  <form class="form" method="post"   action="<?php echo U('Flash/insert',array('tip'=>$tip));?>"  target="_top" enctype="multipart/form-data" >
