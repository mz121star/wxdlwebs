...
<div class="box">
    ...
    <ul class="myinfo">
   <li><p class="red">程序版本：PigCms多用户微信营销系统</p><span>[ 授权版本：商业版 (终身使用权) ]</span></li>
   <li style="display:none"><p class="red" style="display:none">您的程序版本为：PigCms多用户微信营销系统</p><span style="display:none">[ 授权版本：商业版 (终身免费) ]</span></li>
